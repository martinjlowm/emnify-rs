...
pub struct ListofSmSresponse {
    ...
    #[serde(rename = "last_delivery_attempt", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "source_address_type", skip_serializing_if = "Option::is_none")]
    pub source_address_type: Option<serde_json::Value>,
}

impl ListofSmSresponse {
    pub fn new() -> ListofSmSresponse {
        ListofSmSresponse {
            submit_date: None,
            delivery_date: None,
            expiry_date: None,

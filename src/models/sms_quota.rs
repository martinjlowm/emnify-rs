...
pub struct SmsQuota {
    ...
    #[serde(rename = "action_on_exhaustion", skip_serializing_if = "Option::is_none")]
    pub action_on_exhaustion: Option<crate::models::ActionOnExhaustion>,
}

impl SmsQuota {
    pub fn new(volume: f32, expiry_date: String, threshold_percentage: f32, status: crate::models::QuotaStatus) -> SmsQuota {
        SmsQuota {
            volume,
            expiry_date,

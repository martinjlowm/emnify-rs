...
pub struct GetOrganisationActiveTariffPlanResponseTariffPlan {
    ...
    #[serde(rename = "add_active_sims_rate", skip_serializing_if = "Option::is_none")]
    pub add_active_sims_rate: Option<f32>,
    #[serde(rename = "add_active_sim_batch", skip_serializing_if = "Option::is_none")]
    pub add_active_sim_batch: Option<f32>,
    #[serde(rename = "max_service_profiles", skip_serializing_if = "Option::is_none")]
    pub max_service_profiles: Option<f32>,
    #[serde(rename = "max_tariff_profiles", skip_serializing_if = "Option::is_none")]
    ...
    pub price: Option<crate::models::GetOrganisationActiveTariffPlanResponseTariffPlanPrice>,
    #[serde(rename = "currency", skip_serializing_if = "Option::is_none")]
    pub currency: Option<crate::models::GetOrganisationActiveTariffPlanResponseTariffPlanCurrency>,
}

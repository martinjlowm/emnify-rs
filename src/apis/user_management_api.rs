...
pub async fn user_by_id_delete(configuration: &configuration::Configuration, user_id: f32) -> Result<(), Error<UserByIdDeleteError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/v1/user/{user_id}", configuration.base_path, user_id=user_id);
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UserByIdDeleteError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn user_by_id_get(configuration: &configuration::Configuration, user_id: f32) -> Result<crate::models::RetrievetheUserresponse, Error<UserByIdGetError>> {
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UserByIdGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn user_by_id_patch(configuration: &configuration::Configuration, user_id: f32, update_userrequest: crate::models::UpdateUserrequest) -> Result<(), Error<UserByIdPatchError>> {
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UserByIdPatchError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn user_event_page_per_page_sort_by_user_id_and_q_get(configuration: &configuration::Configuration, user_id: f32, page: Option<f32>, per_page: Option<f32>, sort: Option<&str>, q: Option<&str>) -> Result<Vec<crate::models::RetrieveEventsresponse4>, Error<UserEventPagePerPageSortByUserIdAndQGetError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/v1/user/{user_id}/event", configuration.base_path, user_id=user_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UserEventPagePerPageSortByUserIdAndQGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn user_per_page_sort_by_q_and_page_get(configuration: &configuration::Configuration, page: Option<f32>, q: Option<&str>, per_page: Option<f32>, sort: Option<&str>) -> Result<Vec<crate::models::User>, Error<UserPerPageSortByQAndPageGetError>> {
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UserPerPageSortByQAndPageGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn user_per_page_sort_by_q_and_page_post(configuration: &configuration::Configuration, create_userrequest: crate::models::CreateUserrequest) -> Result<(), Error<UserPerPageSortByQAndPagePostError>> {
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UserPerPageSortByQAndPagePostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn user_role_by_id_and_role_id_delete(configuration: &configuration::Configuration, user_id: f32, role_id: f32) -> Result<(), Error<UserRoleByIdAndRoleIdDeleteError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/v1/user/{user_id}/role/{role_id}", configuration.base_path, user_id=user_id, role_id=role_id);
    let mut local_var_req_builder = local_var_client.delete(local_var_uri_str.as_str());
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UserRoleByIdAndRoleIdDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn user_role_by_id_and_role_id_put(configuration: &configuration::Configuration, user_id: f32, role_id: f32) -> Result<(), Error<UserRoleByIdAndRoleIdPutError>> {
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UserRoleByIdAndRoleIdPutError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn user_role_get(configuration: &configuration::Configuration, ) -> Result<Vec<serde_json::Value>, Error<UserRoleGetError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/v1/user/role", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UserRoleGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn user_role_permission_by_id_get(configuration: &configuration::Configuration, user_id: f32) -> Result<serde_json::Value, Error<UserRolePermissionByIdGetError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/v1/user/{user_id}/role/permission", configuration.base_path, user_id=user_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UserRolePermissionByIdGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn user_status_get(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::RetrieveAvailableUserStatusesresponse>, Error<UserStatusGetError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/v1/user/status", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UserStatusGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

...
pub async fn sim_by_id_patch(configuration: &configuration::Configuration, sim_id: f32, update_si_mrequest: crate::models::UpdateSiMrequest) -> Result<(), Error<SimByIdPatchError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&update_si_mrequest);

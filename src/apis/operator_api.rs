...
pub async fn operator_get(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::InlineResponse2001>, Error<OperatorGetError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/v1/operator", configuration.base_path);
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<OperatorGetError> = serde_json::from_str(&local_var_content).ok();

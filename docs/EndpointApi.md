...
> crate::models::RetrieveSingleEndpointresponse endpoint_by_id_get(endpoint_id)
Get Endpoint
...
[**crate::models::RetrieveSingleEndpointresponse**](RetrieveSingleEndpointresponse.md)
...
> endpoint_by_id_patch(endpoint_id, update_endpointrequest)
Update Endpoint
...
------------- | ------------- | ------------- | ------------- | -------------
**endpoint_id** | **f32** | The numeric ID of an Endpoint | [required] |
**update_endpointrequest** | [**UpdateEndpointrequest**](UpdateEndpointrequest.md) |  | [required] |
...
> crate::models::DataQuota endpoint_quota_data_by_endpoint_id_get(endpoint_id)
...
[**crate::models::DataQuota**](Data_Quota.md)
...
> endpoint_quota_data_by_endpoint_id_post(endpoint_id, data_quota1)
Set Data Quota
...
------------- | ------------- | ------------- | ------------- | -------------
**endpoint_id** | **f32** | The numeric ID of an Endpoint | [required] |
**data_quota1** | [**DataQuota1**](DataQuota1.md) |  | [required] |
...
> Vec<serde_json::Value> endpoint_status_get()
...
> Vec<crate::models::ListofEndpointsresponse> get_endpoints(q, sort, page, per_page)
List Endpoints
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**q** | Option<**String**> | Filter parameter in `<filter>:<value>` format. Expects comma separated list of filtering criteria out of the following fields:  * `status` * `service_profile` * `tariff_profile` * `last_updated` * `created` * `name` * `tags` * `ip_address` * `imei`  |  |
...
[**Vec<crate::models::ListofEndpointsresponse>**](ListofEndpointsresponse.md)
